...
class AuthRepository {
  Future<LoginResponse> getLoginResponse(
    ...
    print("reponde.body : "+ response.body);
  ...
  Future<LogoutResponse> getLogoutResponse() async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/auth/logout/${user_id.$}/${access_token.$}");
  ...
  Future<UserByTokenResponse> getUserByTokenResponse() async {
    ...
    final response = await http.post(url,
        ...
        body: post_body);
print("body jean:"+response.body);
    return userByTokenResponseFromJson(response.body);
  }



  Future<UserByTokenResponse> getUserByTokenResponse1(fcmtoken) async {
    //var post_body = jsonEncode({"access_token": "${access_token.$}"});
    //var post_body = jsonEncode({"fcmtoken": "${fcmtoken.$}"});

    Uri url = Uri.parse("${AppConfig.BASE_URL}/get-user-by-access_token1/"+fcmtoken);
