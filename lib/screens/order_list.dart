          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    _orderList[index].payment_status_string=="Paid"? AppLocalizations.of(context).order_list_screen_paid
            ...
            Row(
              children: [
                ...
                Text(
                  _orderList[index].delivery_status_string == "Order Placed" ? AppLocalizations.of(context).order_details_screen_timeline_tile_order_placed
                  :_orderList[index].delivery_status_string == "Confirmed" ? AppLocalizations.of(context).order_details_screen_timeline_tile_confirmed
                  :_orderList[index].delivery_status_string == "Picked Up" ? AppLocalizations.of(context).order_details_screen_timeline_tile_picked_up
                  :_orderList[index].delivery_status_string == "On The Way" ? AppLocalizations.of(context).order_details_screen_timeline_tile_on_the_way
                      :_orderList[index].delivery_status_string == "Delivered" ? AppLocalizations.of(context).order_details_screen_timeline_tile_delivered
                      :_orderList[index].delivery_status_string == "Cancelled" ? AppLocalizations.of(context).order_details_screen_timeline_tile_c
