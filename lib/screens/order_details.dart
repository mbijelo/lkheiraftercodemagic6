          ...
          children: [
            Row(
              children: [
                Text(
                  //"Code commande",
        AppLocalizations.of(context).order_details_screen_order_code,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
                ...
                Text(
                  //"Méthode Livraison",
                    AppLocalizations.of(context).order_details_screen_shipping_method ,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
            ...
            Row(
              children: [
                Text(
                  //"Date commande",
                  AppLocalizations.of(context).order_details_screen_order_date ,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
            ...
            Row(
              children: [
                Text(
                  //"Statu du paiement",
                  AppLocalizations.of(context).order_details_screen_payment_status ,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
                ...
                Spacer(),
                Text(
                  //"Statu de la livraison",
                  AppLocalizations.of(context).order_details_screen_delivery_status ,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      ...
                      _orderDetails.payment_status_string=="Paid"? AppLocalizations.of(context).order_list_screen_paid
                          : AppLocalizations.of(context).order_list_screen_unpaid ,
                      style: TextStyle(
                        color: MyTheme.grey_153,
                      ),
                    ),
                  ...
                  _orderDetails.delivery_status_string == "Order Placed" ? AppLocalizations.of(context).order_details_screen_timeline_tile_order_placed
                      :_orderDetails.delivery_status_string == "Confirmed" ? AppLocalizations.of(context).order_details_screen_timeline_tile_confirmed
                      :_orderDetails.delivery_status_string == "Picked Up" ? AppLocalizations.of(context).order_details_screen_timeline_tile_picked_up
                      :_orderDetails.delivery_status_string == "On The Way" ? AppLocalizations.of(context).order_details_screen_timeline_tile_on_the_way
                      :_orderDetails.delivery_status_string == "Delivered" ? AppLocalizations.of(context).order_details_screen_timeline_tile_delivered
        :_orderDetails.delivery_status_string == "Cancelled" ? AppLocalizations.of(context).order_details_screen_timeline_tile_c
        : _orderDetails.delivery_status_string,
                    style: TextStyle(
                      color: MyTheme.grey_153,
                    ),
            ...
            AppLocalizations.of(context).order_details_screen_shipping_address,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
                ...
                Text(
                  //"Montant Total",
                  AppLocalizations.of(context).order_details_screen_total_amount,
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${AppLocalizations.of(context).order_details_screen_field}: ${_orderDetails.shipping_address.city}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
                        ...
                        Text(
                          "${AppLocalizations.of(context).order_details_screen_city}: ${_orderDetails.shipping_address.state}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
                        ...
                        Text(
                          "${AppLocalizations.of(context).order_details_screen_sedini}: ${_orderDetails.shipping_address.postal_code}",
                          maxLines: 3,
                          style: TextStyle(
                            color: MyTheme.grey_153,
                          ),
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        ...
        style: TextStyle(fontSize: 18, color: MyTheme.black),
      ),
     // elevation: 0.0,
      titleSpacing: 0,
    );
