...
class _SellerDetailsState extends State<SellerDetails> {
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    Padding(
                      ...
                      child: Text(
                            ...
                            .seller_details_screen_new_arrivals.toUpperCase(),
                        style: TextStyle(
                            color: MyTheme.black,
                            fontSize: 16,
                ...
                SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    Padding(
                      ...
                      child: Text(
                        AppLocalizations.of(context)
                            .seller_details_screen_featured_products.toUpperCase(),
                        style: TextStyle(
                            color: MyTheme.black,
                            fontSize: 16,
                            fontWeight: FontWeight.w600),
      ...
      return GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ProductCard(
              ...
              code_p: _featuredProducts[index].code_p);
        },
      );
    } else {
      return Container(
  ...
  buildShowProductsButton(BuildContext context) {
    return FlatButton(
      ...
      child: Text(
        AppLocalizations.of(context)
            .seller_details_screen_btn_view_all_products.toUpperCase(),
        style: TextStyle(
            color: MyTheme.accent_color, fontSize: 16, fontWeight: FontWeight.w600),
      ),
      onPressed: () {
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: ProductCard(
                  ...
                  code_p: _newArrivalProducts[index].code_p,
                ),
              );
            },
          ),
    ...
    return AppBar(
      ...
      actions: <Widget>[
        Padding(
          ...
          child: IconButton(
            icon: Icon(Icons.location_on, color: MyTheme.black),
            onPressed: () {
              showDialog(
                  context: context,
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                _shopDetails.code_s+" : "+_shopDetails.name,
