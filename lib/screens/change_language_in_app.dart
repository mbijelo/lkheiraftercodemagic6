...
class ChangeLanguageInApp extends StatefulWidget {
  ChangeLanguageInApp({Key key}) : super(key: key);

  @override
  _ChangeLanguageInAppState createState() => _ChangeLanguageInAppState();
}

class _ChangeLanguageInAppState extends State<ChangeLanguageInApp> {
