              ...
              Padding(
                ...
                child: Text(
                 // "${ AppLocalizations.of(context).wallet_screen_last_recharged} : ${_balanceDetails.last_recharged}",
                   _balanceDetails.last_recharged == "Not Available" ? AppLocalizations.of(context).wallet_screen_last_recharged + ' : 0.00' : AppLocalizations.of(context).wallet_screen_last_recharged + " : " + _balanceDetails.last_recharged,
                  style: TextStyle(
