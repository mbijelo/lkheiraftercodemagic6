...
class _ProfileEditState extends State<ProfileEdit> {
  ...
  onPressUpdate() async {
    ...
    if (profileUpdateResponse.result == false) {
      ...
      if(profileUpdateResponse.message == "Profile information updated") {
        ToastComponent.showDialog(AppLocalizations.of(context).profiledit, context,
            gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      }
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: FlatButton(
                    ...
                    shape: CircleBorder(
                      side:
                          new BorderSide(color: MyTheme.dark_grey, width: 1.0),
                    ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                    color: MyTheme.brown, fontSize: 16, fontWeight: FontWeight.w600),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        border:
                            Border.all(color: MyTheme.dark_grey, width: 1),
                        borderRadius:
