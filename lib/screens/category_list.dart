...
class _CategoryListState extends State<CategoryList> {
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        getAppBarTitle(),
        style: TextStyle(fontSize: 25, color: MyTheme.black),
      ),
     // elevation: 0.0,
      titleSpacing: 0,
    );
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(16, 0, 0, 0),
                  child:TextButton(
                    child: Text(AppLocalizations.of(context).category_list_screen_view_subcategories),
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(16, 0, 0, 0),
                  child:TextButton(
                    child: Text(AppLocalizations.of(context).category_list_screen_view_products),
                    style: TextButton.styleFrom(
                      primary: Colors.white,
                      backgroundColor: Colors.blueGrey,
                      onSurface: Colors.grey,
