...
class _FilterState extends State<Filter> {
  ...
  Row buildTopAppbar(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <
          ...
          child: Padding(
              ...
              child: TypeAheadField(
                ...
                itemBuilder: (context, suggestion) {
                  ...
                  return ListTile(
                    dense: true,
                    title: Text(suggestion.query,style: TextStyle(color:  suggestion.type != "search" ? MyTheme.black : MyTheme.black,  fontSize:  suggestion.type != "search" ? 16 : 16,  fontWeight:  suggestion.type != "search" ? FontWeight.bold : FontWeight.bold),),
                    subtitle: Text(subtitle,style:TextStyle(color: suggestion.type != "search" ? MyTheme.black: MyTheme.black,  fontSize:  suggestion.type != "search" ? 14 : 14)),
                  );
                },
                ...
                textFieldConfiguration: TextFieldConfiguration(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                          fontSize: 16.0, color: MyTheme.dark_grey),
      ...
      IconButton(
          icon: Icon(Icons.search, color: MyTheme.black),
          onPressed: () {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlatButton(
                      ...
                      child: Text(
                       // "APPLY",
                        AppLocalizations.of(context).common_apply_in_all_capital,
                        style: TextStyle(color: Colors.white),
                      ),
                      onPressed: () {
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCard(
                      ...
                      code_p: _productList[index].code_p,
