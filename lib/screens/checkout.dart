...
class _CheckoutState extends State<Checkout> {
  ...
  fetchSummary() async {
    var cartSummaryResponse = await CartRepository().getCartSummaryResponse(widget.shipping_coast);
  ...
  onPressPlaceOrderOrProceed() {
    ...
    _selected_payment_method = "wallet_system";
  ...
  pay_by_wallet() async {
    ...
    var orderCreateResponse = await PaymentRepository()
        .getOrderCreateResponseFromWallet(
            _selected_payment_method_key, _grandTotalValue, widget.shipping_coast);
    ...
    if(orderCreateResponse.message == "Your order has been placed successfully") {
      ToastComponent.showDialog(AppLocalizations.of(context).orderplaced, context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
    }
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  borderSide:
                      BorderSide(color: MyTheme.black, width: 0.5),
