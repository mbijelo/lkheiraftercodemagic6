...
class _ProductReviewsState extends State<ProductReviews> {
  ...
  onTapReviewSubmit(context) async {
    if (is_logged_in.$ == false) {
      ToastComponent.showDialog(AppLocalizations.of(context).product_reviews_screen_login_warning, context,
    ...
    if (reviewSubmitResponse.result == false) {
      if(reviewSubmitResponse.message == "You cannot review this product") {
        ToastComponent.showDialog(AppLocalizations.of(context).cannotreviewproduct, context,
            gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      }
        return;
    ...
    if(reviewSubmitResponse.message == "Review Submitted") {
      ToastComponent.showDialog(AppLocalizations.of(context).reviewsubmitted, context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
    }
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(
                        fontSize: 14.0, color: MyTheme.dark_grey),
