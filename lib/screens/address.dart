...
class _AddressState extends State<Address> {
  ...
  List<TextEditingController> _villeControllerListForUpdate = [];
    ...
    if (_shippingAddressList.length > 0) {
      ...
      _shippingAddressList.forEach((address) {
        ...
        _cityControllerListForUpdate
            .add(TextEditingController(text: address.city_id));
  ...
  reset() {
    ...
    _villeControllerListForUpdate.clear();
  ...
  afterAddingAnAddress1() {
    reset();
    fetchAll();
    ToastComponent.showDialog(AppLocalizations.of(context).flash_deal_list_screen_ended, context,
  ...
  afterUpdatingAnAddress1() {
    reset();
    fetchAll();
    ToastComponent.showDialog(AppLocalizations.of(context).common_update_in_all_capital, context,
        gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
    setState(() {showLoading = false;});
  }
  ...
  confirmDelete(id) async {
    ...
    if(addressDeleteResponse.message == "Shipping information has been deleted") {
      ToastComponent.showDialog(AppLocalizations.of(context).addressdeleted, context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
    }
    afterDeletingAnAddress();
  }
  ...
  onAddressAdd(context) async {
    ...
    var quartier = _villeController.text.toString();
    ...
    if (phone == "") {
      ToastComponent.showDialog(
          AppLocalizations.of(context).address_screen_phone_warning, context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
...
*/
  ...
  onAddressUpdate(context, index, id) async {
    ...
    var quartier = _cityControllerListForUpdate[index].text.toString();
...
*/
    ...
    if (addressUpdateResponse.result == true) {
      //Navigator.of(context, rootNavigator: true).pop();
      afterUpdatingAnAddress1();
      return;
    }
  ...
  onSelectCityDuringUpdate(index, city, setModalState) {
    if (_selected_city_list_for_update[index] != null &&
      ...
      setModalState(() {
        _cityControllerListForUpdate[index].text = city.id;
      });
      return;
    }
                ...
                :Padding(
                  ...
                  child: FlatButton(
                    ...
                    shape: RoundedRectangleBorder(
                        ...
                        side:
                            BorderSide(color: MyTheme.dark_grey, width: 1.0)),
                    child: Icon(
                      FontAwesome.plus,
                      color: MyTheme.black,
                      size: 16,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Text(
                            AppLocalizations.of(context).order_details_screen_sedini,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlatButton(
                        ...
                        child: Text(
                          //"ADD",
                          AppLocalizations.of(context).common_add_in_all_capital,
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            _shippingAddressList[index].city_id,
                            maxLines: 2,
                            style: TextStyle(
                                color: MyTheme.dark_grey,
                                fontWeight: FontWeight.w600),
