...
class _CartState extends State<Cart> {
  ...
  confirmDelete(cart_id) async {
    ...
    if (cartDeleteResponse.result == true) {
      if(cartDeleteResponse.message=="Product is successfully removed from your cart") {
        ToastComponent.showDialog(AppLocalizations.of(context).rmfromcart, context,
  ...
  process({mode}) async {
    ...
    var cartProcessResponse = await CartRepository()
        .getCartProcessResponse(cart_ids_string, cart_quantities_string, _shopList.length);
    ...
    if (cartProcessResponse.result == false) {
      ...
      if (cartProcessResponse.message == "Cart updated"){
        ToastComponent.showDialog(AppLocalizations.of(context).cartupdated, context,
            gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
    }
                  ...
                  slivers: [
                    ...
                    SliverList(
                      delegate: SliverChildListDelegate([
                        Padding(
                          padding: const EdgeInsets.only(top: 50.0, bottom: 16.0, left: 16.0, right: 16.0),
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            _shopList[index].name == "Inhouse" ? "Al kheir" : _shopList[index].name ,
  ...
  buildCartSellerItemCard(seller_index, item_index) {
    return Card(
      shape: RoundedRectangleBorder(
        side: BorderSide(color: MyTheme.dark_grey, width: 1.0),
        borderRadius: BorderRadius.circular(8.0),
      ),
      elevation: 0.0,
              ...
              Padding(
                ...
                child: Text(
                  _shopList[seller_index]
                      ...
                      .quantity
                      .toString(),
                  style: TextStyle(color: MyTheme.brown, fontSize: 18),
                ),
              ),
              SizedBox(
                width: 28,
