...
class AppConfig {
  static String copyright_text = "@ Al Kheir " + this_year; //this shows in the splash screen
  static String app_name = "Al Kheir"; //this shows in the splash screen
  ...
  //configure this
  static const DOMAIN_PATH = "tigerrsoft.com/elmarsa"; //localhost
