...
class CartRepository {
  ...
  Future<CartProcessResponse> getCartProcessResponse(
      @required String cart_ids, @required String cart_quantities, nbreShop) async {
    var post_body = jsonEncode(
        {"cart_ids": "${cart_ids}", "cart_quantities": "$cart_quantities", "nbreShop":nbreShop});
  ...
  Future<CartSummaryResponse> getCartSummaryResponse(shippinCoast) async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/cart-summary/${user_id.$}/${shippinCoast}");
